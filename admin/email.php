...
if (!(isset($_SESSION["username"])) || $_SESSION["username"] == "") {
    ...
    <div id="container">
        ...
        <span
            class="notetext">There are three types of emails: <strong>Verbose</strong> are fully-detailed messages, <strong>Terse</strong> are stripped down to only the most important details, and <strong>GEF (Gmail Event Format)</strong> is formatted to work with Gmail Events.</span>
        <ul id="settingsul">
            <li>
                ...
                <ul>
                    <li>
                        <form name="onreserveverbose" action="email.php" method="POST">Verbose: <input type="text"
                                ...
                                type="hidden" name="op" value="email_res_verbose"/><input type="submit" value="Save"/>
                        </form>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <form name="oncondition" action="email.php" method="POST">When <select name="email_condition">
                                ...
                                <option
                                    value="duration"<?php if ($settings["email_condition"] == "duration") echo " selected"; ?>>
                                    Duration
                                </option>
                                <option
                                    value="capacity"<?php if ($settings["email_condition"] == "capacity") echo " selected"; ?>>
                                    Number In Group
                                </option>
                                <?php
                ...
                <ul>
                    <li>
                        <form name="oncancelverbose" action="email.php" method="POST">Verbose: <input type="text"
                                ...
                                type="hidden" name="op" value="email_can_verbose"/><input type="submit" value="Save"/>
                        </form>
                    </li>
                    <li>
