...
<body>
	...
	<ul>
			...
			<li><a href="administrators.php">Administrators</a><em> - Add/Remove users with full administrative access.</em></li>
			<li><a href="reporters.php">Reporters</a><em> - Add/Remove users with limited administrative access.</em></li>
			<li><a href="bans.php">Banned Users</a><em> - Prevent certain users from accessing the reservation system.</em></li>
	</ul>
	<h3>Room Management</h3>
	<ul>
		<li><a href="specialhours.php">Special Hours</a><em> - Set up room closures, holidays, etc.</em></li>
		<li><a href="rooms.php">Rooms</a><em> - Add, modify, or remove rooms and their descriptions, capacities, names, etc.</em></li>
		<li><a href="defaulthours.php">Default Hours</a><em> - Set up default hours for rooms by weekday.</em></li>
		<li><a href="roomgroups.php">Room Groups</a><em> - Add, modify, or remove room groups.</em></li>
	</ul>
	<h3>Reservation Tools</h3>
	<ul>
		<li><a href="customfields.php">Custom Fields</a><em> - Set up custom form fields that appear when users make reservations.</em></li>
		<li><a href="email.php">Email Setup</a><em> - Set up a list of email addresses to send verbose, terse, or Gmail Event Format reservation/cancellation notices.</em></li>
		<li><a href="multiplereservations.php">Multiple Reservations</a><em> - Create repeating reservations quickly using this tool.</em></li>
		<li><a href="timing.php">Timing and Limitations</a><em> - Change the time interval, time format, and set quantity and duration limits on reservations.</em></li>
	</ul>
	<h3>Settings</h3>
	<ul>
		<li><a href="configuration.php">Configuration</a><em> - Change the name of the system, security settings, login settings, email filters, themes, etc.</em></li>
		<li><a href="policies.php">Policies</a><em> - Edit the text on the page that users see when they click "Policies".</em></li>
			...
			<ul>
				<li>
					<form name="daily" method="POST" action="report-canceldaily.php">
						For the period starting: <input id="fromc" size="10" maxlength="10" name="fromc" type="text">
				<img src="../includes/datechooser/calendar.gif" onclick="showChooser(this, 'fromc', 'chooserSpan3', 1950, 2060, Date.patterns.ShortDatePattern, false);">
				<div id="chooserSpan3" class="dateChooser select-free" style="display: none; visibility: hidden; width: 160px;"></div>
						and ending: <input id="toc" size="10" maxlength="10" name="toc" type="text">
				<img src="../includes/datechooser/calendar.gif" onclick="showChooser(this, 'toc', 'chooserSpan3', 1950, 2060, Date.patterns.ShortDatePattern, false);">
				<div id="chooserSpan3" class="dateChooser select-free" style="display: none; visibility: hidden; width: 160px;"></div>
				<input type="submit" value="Run Report" />
					</form>
				</li>
