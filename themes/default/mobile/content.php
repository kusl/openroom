    ...
    switch ($op) {
        case 'makereservation':
			...
			<div id="makereservation">
				...
				<select name="duration"><option>How long is your meeting?</option>
					<?php
				...
				<select name="size"><option>How many people in your group?</option>
					<?php
				...
				<div id="loader"></div><input id="find_room_button" class="find_room_button" type="submit" onClick="reservation_check(this.form);" value="Find me a room" />
				</form>
            ...
            while ($your_res = mysql_fetch_array($your_reservations)) {
                ...
                while ($option_field = mysql_fetch_array($option_fields)) {
                    echo '<span class="resoption">'.$option_field['optionname'].': '.$option_field['optionvalue'].'</span><br/>';
								...
								<td class="reservation_button_right" onClick="confirm_cancel(<?php echo $your_res['reservationid']; ?>)">
									Cancel
								</td>
							</tr>
						</table>
